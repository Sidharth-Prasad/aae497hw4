...
casadi_int rocket_aero_moment_n_out(void);
casadi_int rocket_aero_moment_n_in(void);
const char* rocket_aero_moment_name_in(casadi_int i);
const char* rocket_aero_moment_name_out(casadi_int i);
